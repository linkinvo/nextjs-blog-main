...
import productSchema from 'redux/models/PropertiesSaga';
              ...
              <main className='mt-6 xl:flex-1 xl:overflow-y-scroll'>
                ...
                <div className=' mt-6'>
                  <div className='flex flex-wrap px-4 sm:inline-flex sm:pt-2 sm:pb-8 xl:px-8 gap-5'>
                    ...
                    {
                      properties &&  Object.values(properties).map((id: any) =>
                        ...
                        <div className='relative pb-5/6'>
                          <Link key={properties.id} href={`/properties/${properties.id}`}>
                            <a><img className='absolute insert-0 h-full rounded-lg shadow-md object-cover' src={id.img} alt="modern-home" /></a>
                          </Link>
                        </div>
                            ...
                            <Link key={properties.id} href={`/properties/${properties.id}`}>
                              <a><div className='flex'>
                                ...
                                <div className='ml-2 text-xs text-gray-600 font-semibold uppercase tracking-wide'>
                                  {id.beds} beds &bull; {id.baths} baths
                                </div>
                              </div></a>
                            </Link>
                            <h4 className='mt-1 text-gray-900 font-semibold text-lg'>{id.description}</h4>
                            <div className='mt-1'>
                              <span className='text-gray-900'>$ {id.price}/wk</span>
                              <span className='ml-1 text-sm text-gray-600'>{id.currency}</span>
                            </div>
